...
function Client(constructor) {
    ...
    //    initialDelay: self._constructor.retry.minTimeout || 500,
...
//Client.prototype._backoff = function _backoff() {
//    var self = this;
//    var max = Infinity;
//    self._backingOff=true;
//    var retry = backoff.call(self._createConnection(this), {},
//        function (err, con) {
//            if(!err){
...
//    }));
//
//    if (typeof (self._constructor.retry.retries) === 'number')
//        max = self._constructor.retry.retries;
//
//    retry.failAfter(max);
//};
...
Client.prototype._createConnection = function _createConnection() {
    var self = this;
        self._constructor.create(self._onConnection);
};
