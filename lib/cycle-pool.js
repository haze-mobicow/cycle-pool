...
Client.prototype._ensureClients = function _ensureClients() {
    ...
    if(self._constructor.size === self.pools.clients.length){
        console.log('Equal',self._constructor.size ,self.pools.clients.length);
        return true;
    }

    var sizeLeft = self._constructor.size - self.pools.clients.length;
    //if(self._ready){
    //    sizeLeft = self._constructor.size - self.pools.clients.length;
    //}
    ...
    for(var i =0;i<sizeLeft;i++){
        ...
        //    if(self._backingOff){
        //        this._created = self.pools.clients.length;
        //        break;
        //    }
        //    self._created += 1;
        //
        ...
        // setImmediate(function(){self._createConnection()});
    }
};
